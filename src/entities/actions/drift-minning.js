...
export class DriftMining extends Action {
    constructor() {
        super('drift-mining', 'Drift mining', NEXUS.AND_OR);
        
        const subaction1 = new SubAction();
        subaction1.goods.push(new StockableGood(GOODS.STONE, 2, 2));

        const subaction2 = new SubAction();
        subaction2.goods.push(new FixedGood(GOODS.CAVERN_TUNNEL, 1));
